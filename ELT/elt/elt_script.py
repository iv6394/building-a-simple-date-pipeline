...
def wait_for_postgres(host, max_retries=5, delay_seconds=0):
    ...
    while retries < max_retries:
        try:
            ...
            print("Error executing pg_isready:", e)
            print("pg_isready output:", e.stdout)
            print("pg_isready error:", e.stderr)
